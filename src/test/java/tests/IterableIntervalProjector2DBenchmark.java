...
public class IterableIntervalProjector2DBenchmark
{
	...
	{
		final IterableIntervalProjector2D< UnsignedByteType, ARGBType > projector = new IterableIntervalProjector2D<>( 0, 1, in, out, new RealARGBConverter< UnsignedByteType >( 0, 1000 ) );
