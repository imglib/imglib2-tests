...
public class CompositeXYRandomAccessibleProjectorBenchmark
{
	...
	{
		final CompositeXYRandomAccessibleProjector< UnsignedByteType > projector = new CompositeXYRandomAccessibleProjector<>( in, out, ChannelARGBConverter.converterListRGBA, 2 );
